...
public partial class LazyFrame : IDisposable, IPolarsLazyFrame
{
    ...
    /// </code>
    /// </example>
    public LazyFrame Select(params IntoExprColumn[] exprs)
    {
    ...
    /// </summary>
    public LazyFrame Select(params IEnumerable<IntoExprColumn> exprs) => Select(exprs.ToArray());
    /// <summary>
    ...
    public LazyFrame Select(IEnumerable<string> columns)
    {
        ...
        var intoExprs = new IntoExprColumn[cols.Length];
...
public partial class DataFrame : IDisposable,IEnumerable<Series>,IPolarsDataFrame
{
    ...
    /// </code>
    /// </example>
    public DataFrame Select(params IntoExprColumn[] columns) => Lazy().Select(columns).Collect();
    /// <summary>
    ...
    /// <remarks>
    /// For more advanced selections (renaming, calculations), use <see cref="Select(IntoExprColumn[])"/>.
    /// </remarks>
    ...
    /// Usage: lf.Select(["Id", "Name", "Date"])
    /// </summary>
    public DataFrame Select(params IEnumerable<IntoExprColumn> exprs) => Lazy().Select(exprs).Collect();
}