...
public readonly partial struct Polars
{
    ...
    /// </summary>
    public static When When(IntoExpr condition)
...
public class When
{
    ...
    public Then Then(IntoExpr statement)
    {
...
public class Then
{
    ...
    public ChainedWhen When(IntoExpr condition)
    ...
    /// </summary>
    public Expr Otherwise(IntoExpr statement)
    {
