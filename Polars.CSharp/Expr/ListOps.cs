...
public readonly struct ListOps
{
    ...
    public Expr Gather(IntoExpr indices,bool nullOnOob=false) => new(PolarsWrapper.ListGather(_expr.CloneHandle(),indices.Consume().Handle,nullOnOob));
    public Expr Gather(ReadOnlySpan<int> indices,bool nullOnOob=false) => Gather(Pl.Lit(indices),nullOnOob);
    public Expr GatherEvery(IntoExpr n,IntoExpr offset) => new(PolarsWrapper.ListGatherEvery(_expr.CloneHandle(),n.Consume().Handle,offset.Consume().Handle));
    public Expr GatherEvery(IntoExpr n) => GatherEvery(n,0);
    /// <summary>
    /// Slice every sublist.
    /// </summary>
    ...
    public Expr Head(IntoExpr n) => new(PolarsWrapper.ListHead(_expr.CloneHandle(),n.Consume().Handle));
    public Expr Head(long n=5) => Head(Pl.Lit(n));
    public Expr Tail(IntoExpr n) => new(PolarsWrapper.ListTail(_expr.CloneHandle(),n.Consume().Handle));
    ...
    public Expr SampleN(IntoExpr n,bool withReplacement=false,bool shuffle=false,ulong? seed=null)
    {
    ...
    public Expr SampleFrac(IntoExpr fraction,bool withReplacement=false,bool shuffle=false,ulong? seed=null)
        => new(PolarsWrapper.ListSampleFraction(_expr.CloneHandle(),fraction.Consume().Handle,withReplacement,shuffle,seed));
    public Expr SetUnion(IntoExpr other) => new(PolarsWrapper.ListSetUnion(_expr.CloneHandle(),other.Consume().Handle));
    ...
    public Expr SetDifference(IntoExpr other) => new(PolarsWrapper.ListSetDifference(_expr.CloneHandle(),other.Consume().Handle));
    ...
    public Expr SetIntersection(IntoExpr other) => new(PolarsWrapper.ListSetIntersection(_expr.CloneHandle(),other.Consume().Handle));
    ...
    public Expr SetSymmetricDifference(IntoExpr other) => new(PolarsWrapper.ListSetSymmetricDifference(_expr.CloneHandle(),other.Consume().Handle));
    ...
    public Expr Concat(params IntoExpr[] others)
    {
