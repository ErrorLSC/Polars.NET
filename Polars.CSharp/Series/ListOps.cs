...
public readonly struct SeriesListOps
{
    ...
    public Series Gather(IntoExpr indices,bool nullOnOob=false) => Apply(e=>e.List.Gather(indices,nullOnOob));
    /// <inheritdoc cref="Gather(IntoExpr,bool)"/>
    ...
    /// <returns></returns>
    public Series GatherEvery(IntoExpr n,IntoExpr offset) => Apply(e=>e.List.GatherEvery(n,offset));
    /// <inheritdoc cref="GatherEvery(IntoExpr,IntoExpr)"/>
    public Series GatherEvery(IntoExpr n) => GatherEvery(n,0);
    /// <inheritdoc cref="ListOps.Slice"/>
    public Series Slice(IntoExpr offset, IntoExpr? length=null) => Apply(e=>e.List.Slice(offset,length));
    /// <summary>
    /// Slice the first n values of every sublist.
    /// </summary>
    /// <param name="n">Number of values to return for each sublist.</param>
    /// <returns></returns>
    public Series Head(IntoExpr n) =>Apply(e=>e.List.Head(n));
    /// <inheritdoc cref="Head(IntoExpr)"/>
    ...
    /// <param name="n">Number of values to return for each sublist.</param>
    /// <returns></returns>
    public Series Tail(IntoExpr n) =>Apply(e=>e.List.Tail(n));
    /// <inheritdoc cref="Tail(IntoExpr)"/>
    ...
    public Series SampleN(IntoExpr n,bool withReplacement=false,bool shuffle=false,ulong? seed=null)
        => Apply(e=>e.List.SampleN(n,withReplacement,shuffle,seed));
    /// <inheritdoc cref="SeriesListOps.SampleN(IntoExpr,bool,bool,ulong?)"/>
    ...
    public Series SampleFrac(IntoExpr fraction,bool withReplacement=false,bool shuffle=false,ulong? seed=null)
    ...
    public Series SetUnion(IntoExpr other) => Apply(e=>e.List.SetUnion(other));
    ...
    /// </summary>
    /// <param name="other">Right hand side of the set operation.</param>
    public Series SetDifference(IntoExpr other) => Apply(e=>e.List.SetDifference(other));
    ...
    /// </summary>
    /// <param name="other">Right hand side of the set operation.</param>
    public Series SetIntersection(IntoExpr other) => Apply(e=>e.List.SetIntersection(other));
    ...
    /// </summary>
    /// <param name="other">Right hand side of the set operation.</param>
    public Series SetSymmetricDifference(IntoExpr other) => Apply(e=>e.List.SetSymmetricDifference(other));
    ...
    /// </summary>
    public Series Concat(IntoExpr other) 
    ...
    /// </summary>
    public Series Concat(params IntoExpr[] others)
    {
